...
function Frame259() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[10px] items-start relative shrink-0 text-center text-nowrap whitespace-pre">
      <p className="relative shrink-0 text-[20px]">Stribingo</p>
...
function Testimonial1() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 1">
      <Frame259 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
}
...
function Frame260() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 text-center text-nowrap whitespace-pre">
      <p className="font-['SF_Pro_Display:Bold',sans-serif] relative shrink-0 text-[20px]">Stribingo</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[16px]">⭐⭐⭐⭐⭐</p>
    </div>
  );
}
...
function Testimonial2() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 2">
      <Frame260 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
...
function Testimonial3() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 3">
      <Frame261 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
...
function Testimonial4() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 4">
      <Frame262 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
...
function Testimonial5() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 5">
      <Frame263 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
...
function Testimonial6() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 6">
      <Frame264 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
...
function Testimonial7() {
  return (
    <div className="bg-[#fcf4f3] box-border content-stretch flex flex-col gap-[10px] items-start justify-center leading-[normal] not-italic p-[20px] relative rounded-[20px] shrink-0 text-[#1e1e1e]" data-name="Testimonial 7">
      <Frame266 />
      <p className="font-['SF_Pro_Display:Medium',sans-serif] relative shrink-0 text-[16px] w-[176px]">Saves us thousands every month. Incredible value.</p>
    </div>
  );
